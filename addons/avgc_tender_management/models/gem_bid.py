...
class GemBidStageDependency(models.Model):
    _name = 'avgc.gem.bid.stage.dependency'
    _description = 'GeM Bid Stage Dependency'
    
    stage_id = fields.Many2one('avgc.gem.bid.stage', string='Stage', required=True, ondelete='cascade')
    depends_on_stage_id = fields.Many2one('avgc.gem.bid.stage', string='Depends on Stage', required=True)
