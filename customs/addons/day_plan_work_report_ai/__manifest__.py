...
# -*- coding: utf-8 -*-
{
    ...
    'assets': {
        'web.assets_backend': [
            # ✅ JavaScript files
            'day_plan_work_report_ai/static/src/js/dashboard.js',
            'day_plan_work_report_ai/static/src/js/day_plan_calendar.js',
            # ✅ XML templates
            'day_plan_work_report_ai/static/src/xml/dashboard_templates.xml',
        ],
        'web.assets_frontend': [
            # Add frontend assets if needed
        ]
    ...
    'external_dependencies': {
        'python': ['requests'],  # Add AI library dependencies when needed
    },
