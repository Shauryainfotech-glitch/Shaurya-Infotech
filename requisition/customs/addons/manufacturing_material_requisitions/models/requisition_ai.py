...
class RequisitionAI(models.Model):
    ...
    def _train_anomaly_detection_model(self):
        ...
        # Use simple statistical methods for anomaly detection instead of scipy
        ...
        anomaly_rate = (anomaly_count / (total_records * len(features))) * 100 if total_records > 0 else 0
